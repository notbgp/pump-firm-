            ...
            <>
              ...
              <div className="mb-4">
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className="bg-white/10 text-white px-4 py-3 rounded-xl border border-white/20 focus:border-purple-500 outline-none"
                  >
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="flex-1 bg-white/10 text-white px-4 py-3 rounded-xl border border-white/20 focus:border-purple-500 outline-none text-right text-xl"
                  />
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="flex-1 bg-white/5 text-gray-400 px-4 py-3 rounded-xl border border-white/10 text-rig
